...
import ClientLayout from "@/components/userLayout/userLayout"
  ...
  return(
    ...
    <div className={styles.container}>
      <div className={styles.mainContainer}>
        <h3 className="text-2xl font-bold text-gray-800>">User List</h3>
<Button onClick={() => router.push("/clients/addClient")}>Add User</Button>
      </div>
